...
export const metadata: Metadata = {
  ...
  description: 'AI-powered chatbot with retrieval-augmented generation for accurate, context-aware responses to fintech FAQ queries.',
  keywords: [
    'AI chatbot',
    'fintech',
    'FAQ assistant',
  ...
  openGraph: {
    ...
    description: 'AI-powered chatbot for fintech FAQ support with real-time streaming responses.',
